...
- Name: api.spec.ts >> API /api/leads — captura de leads >> guarda lead del formulario de landing
- Location: tests/api.spec.ts:74:7
...
> 84  |     expect([200, 201]).toContain(res.status())
  ...
  119 |         expect(pool.carrier_rate).toBeLessThanOrEqual(285)
  120 |       }
  121 |     }
  122 |   })
  123 | })
