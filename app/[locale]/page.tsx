    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-900 via-brand-700 to-brand-600 py-24 text-white">
      ...
      <div className="container relative text-center">
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <a
            href="#pre-registro"
            className="rounded-xl bg-emerald-500 px-8 py-3.5 text-base font-semibold text-white shadow-lg hover:bg-emerald-400 transition-colors"
          >
            Quiero precio de pool
          </a>
          <a
            href={`${prefix}/pools`}
